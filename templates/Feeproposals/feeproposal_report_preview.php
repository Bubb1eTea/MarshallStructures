...
<buttoner style='float: right; margin-right: 25px;padding: 0px;'>
    <?= $this->Html->link(__(' Download to pdf'), ['action' => 'feeproposalReport', $feeproposal->id ], ['class' => 'button']); ?>
</buttoner>
...
<head>
    ...
    <style>
        ...
        </style></head><body lang=EN-US style='word-wrap:break-word'><div class="contenter"><div class=WordSection1><p class=MsoNormal align=center style='margin-top:6.0pt;margin-right:0cm;
margin-bottom:6.0pt;
        margin-left:0cm;
        text-align:center'><b><span lang=EN-AU
style='font-size:18.0pt'>Engagement Agreement</span></b></p><p class=MsoNormal align=center style='margin-top:6.0pt;margin-right:0cm;
margin-bottom:6.0pt;
        margin-left:0cm;
        text-align:center'><b><span lang=EN-AU
...
<br></span></b></p>
        ...
        $invoiceAddresseeCheck=$feeproposal->project->invoiceaddressee;
...
margin-left:0cm;
        ...
        <p class=MsoNormal style='margin-top:6.0pt;margin-right:0cm;margin-bottom:6.0pt;
margin-left:0cm;
        text-align:justify'><b><span lang=EN-AU style='font-size:11.0pt'>CLIENT: <?=$feeproposal['project']['invoiceaddressee']['firstname'].' '.$feeproposal['project']['invoiceaddressee']['lastname']?></span></b></p>
        <?php } else {?>
        <p class=MsoNormal style='margin-top:6.0pt;margin-right:0cm;margin-bottom:6.0pt;
            margin-left:0cm;text-align:justify'><b><span lang=EN-AU style='font-size:11.0pt'>CLIENT: </span></b></p>
        <?php }

        $guarCheck = $feeproposal->guarantor;
    if(!empty($guarCheck)){ ?>
...
margin-left:0cm;
        border:none;
        padding:0cm'><span lang=EN-AU style='font-size: 11.0pt'>The scope of services to be provided are as follows-&#8194;&#8194;</span></p>

        </div><p class=MsoListParagraphCxSpFirst style='margin-top:2.0pt;margin-right:0cm;
margin-bottom:6.0pt;
        margin-left:64.35pt;
        text-indent:-18.0pt'><span lang=EN-AU
style='font-size:11.0pt;font-family:Symbol'><span style='font:7.0pt "Times New Roman"'>&nbsp;
        ...
        &nbsp;
        &nbsp;
        </span></span><span lang=EN-AU style='font-size:11.0pt'><?=nl2br($feeproposal->scopeofservice) ?></span></p><p class=MsoNormal style='margin-top:2.0pt;margin-right:0cm;margin-bottom:6.0pt;
margin-left:1.0cm'><span lang=EN-AU>&#8194;</span></p>

        <p class=Newhdg align=left style='text-align:left'><span lang=EN-AU>2.<span style='font:7.0pt "Times New Roman"'>&nbsp;
        &nbsp;
        &nbsp;
        &nbsp;
        &nbsp;
...
margin-left:1.0cm'><span lang=EN-AU style='font-size:11.0pt'>In the course of the Services being provided it may be necessary to incur disbursements, which are fees, expenses and charges which will be charged to the Client at cost +10%.</span></p>
        ...
        <p class=MsoNormal style='margin-top:6.0pt;margin-right:0cm;margin-bottom:6.0pt;
margin-left:1.0cm;
        page-break-after:avoid'><b><span lang=EN-AU style='font-size: 11.0pt'><br> Total professional fees and disbursements</span></b></p>
...
margin-bottom:6.0pt;margin-left:0cm;text-align:center'><span lang=EN-AU style='font-size:14.0pt'>*** END ***</span></p>
...
avoid'><a name="_Hlk503877131"></a><a name="_Hlk503864317"></a><a name="_Hlk503877011"><b><span lang=EN-AU style='font-size:11.0pt;text-transform:
...
margin-left:42.55pt;margin-right:0cm'>
        ...
        <p class=MsoNormal style='margin-top:6.0pt;text-align:justify;page-break-after:
avoid;border:none;padding:0cm'><span lang=EN-AU style='font-size:11.0pt'>I</span><span lang=EN-AU
                style='font-size:11.0pt'> accept the above terms:</span></p>
...
color:red'> </span></p>
        ...
        <p class=MsoNormal style='margin-top:6.0pt;text-align:justify;page-break-after:
avoid;border:none;padding:0cm'><span lang=EN-AU
                style='font-size:11.0pt'>.....................................................................................................................
            </span></p>

        <p class=MsoNormal style='margin-top:6.0pt;text-align:justify;page-break-after:
avoid;border:none;padding:0cm'><b><span lang=EN-AU style='font-size:11.0pt;
text-transform:uppercase'>Benjamin Peter Marshall</span></b><b><span lang=EN-AU
                    style='font-size:11.0pt;text-transform:uppercase'> </span></b></p>
...
margin-left:42.55pt;margin-right:0cm'>
        ...
        <p class=MsoNormal style='margin-top:6.0pt;text-align:justify;page-break-after:
avoid;border:none;padding:0cm'><a name="_Hlk503877887"><span lang=EN-AU style='font-size:11.0pt'>I</span></a><span
                lang=EN-AU style='font-size:11.0pt'>
...
avoid;border:none;padding:0cm'><span lang=EN-AU
        ...
        <p class=MsoNormal style='margin-top:6.0pt;text-align:justify;page-break-after:
avoid;border:none;padding:0cm'><span lang=EN-AU style='font-size:11.0pt'>Name:</span><span lang=EN-AU
