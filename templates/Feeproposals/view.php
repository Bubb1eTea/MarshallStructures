...
<div class="row">
    ...
    <div class="column-responsive column-80">
        <div class="feeproposals view content">
            ...
            <buttoner style='float: right; padding-right:10px;'> <?= $this->Html->link(__('View Generated Template'), ['action' => 'feeproposalReportPreview'], ['class' => 'button float-right']); ?></buttoner> 
            </h3>
            <table>
                <tr>
                    <th><?= __('Project') ?></th>
