                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td class="actions">
                                ...
                                <?php // echo $this->Form->postLink(__('Delete'), ['controller' => 'Associates', 'action' => 'delete', $associates->id], ['confirm' => __('Are you sure you want to delete associate "{0}"?', $associates->full_name)]) ?>                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </table>
                </div>
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td class="actions">
                                ...
                                <?php // echo $this->Form->postLink(__('Delete'), ['controller' => 'Clients', 'action' => 'delete', $clients->id], ['confirm' => __('Are you sure you want to delete client "{0}"?', $clients->full_name)]) ?>                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </table>
                </div>
