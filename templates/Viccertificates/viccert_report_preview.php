...
<buttoner style='float: right; margin-right: 25px;padding: 0px;'>
    <?= $this->Html->link(__(' Download to pdf'), ['action' => 'viccertReport', $viccertificate->id ], ['class' => 'button']); ?>
</buttoner>
...
<head>
    ...
    <title>Building Form: Certificate of Compliance for proposed building work</title>
    <style>
        <!--
        /* Font Definitions */
        ...
        li.DraftHeading3,
        div.DraftHeading3 {
            mso-style-name: "Draft Heading 3";
            mso-style-link: "Draft Heading 3 Char";
            margin-top: 6.0pt;
            margin-right: 0cm;
            margin-bottom: 0cm;
            margin-left: 0cm;
        ...
        li.DraftHeading4,
        div.DraftHeading4 {
            mso-style-name: "Draft Heading 4";
            mso-style-link: "Draft Heading 4 Char";
            margin-top: 6.0pt;
            margin-right: 0cm;
            margin-bottom: 0cm;
            margin-left: 0cm;
        ...
        span.Normal-ScheduleChar {
            mso-style-name: "Normal - Schedule Char";
            mso-style-link: "Normal - Schedule";
        }

        p.Normal-Schedule,
        li.Normal-Schedule,
        div.Normal-Schedule {
            mso-style-name: "Normal - Schedule";
            mso-style-link: "Normal - Schedule Char";
            margin-top: 6.0pt;
            margin-right: 0cm;
            margin-bottom: 0cm;
            margin-left: 0cm;
    ...
    <table class=MsoTableGrid border=0 cellspacing=0 cellpadding=0 style='border-collapse:collapse;border:none'>
        <tr>
            ...
            <td width=86 valign=top style='width:64.45pt;padding:0cm 5.4pt 0cm 5.4pt'>
                <p class=Normal-Schedule><span lang=EN-AU>Postcode: </span><!-- insert postcode -->
                    <?= $viccertificate->company->postcode ?></p>
            </td>
            <td width=71 valign=top style='width:53.45pt;padding:0cm 5.4pt 0cm 5.4pt'>
                <p class=Normal-Schedule align=right style='text-align:right'><span lang=EN-AU>&nbsp;</span> </p>
            </td>
        </tr>
        <tr>
            <td width=85 valign=top style='width:63.55pt;padding:0cm 5.4pt 0cm 5.4pt'>
                <p class=Normal-Schedule><span lang=EN-AU>Email:</span> <!-- insert email -->
                    <?= $viccertificate->company->email ?></p>
            </td>
            <td width=359 valign=top style='width:269.35pt;padding:0cm 5.4pt 0cm 5.4pt'>
                <p class=Normal-Schedule><span lang=EN-AU>&nbsp;</span></p>
            </td>
    ...
    <p class=MsoNormal><b><span lang=EN-AU>This certificate is issued in relation
                to the proposed building work at</span></b><span lang=EN-AU>: </span></p>
    ...
    <p class=Normal-Schedule><span lang=EN-AU>Storeys contained: </span> <!-- insert stories contained -->
        <?=$viccertificate->numberofstorey?> </p>
    ...
    <p class=Normal-Schedule><span lang=EN-AU>Effective height: <?=$viccertificate->effectiveheight?>
            <!-- insert Effective height --></span></p>
    ...
    <p class=MsoNormal><b><span lang=EN-AU style='font-size:14.0pt;line-height:
107%'>Prescribed class of building work for which this certificate is issued:</span></b></p>
    ...
    <p class=MsoNormal><span lang=EN-AU>Design or part of the design of building
            work relating to
            <!-- insert building work relation--><?=$viccertificate->workrelatingto?> </span></p>
    ...
    <table border="1" width="100%" style="collapse: collapse">
        ...
        <tr>
            <td><?php if(!empty($documentsproducedarray[$y*3-3])) echo "&nbsp "; echo $documentsproducedarray[$y*3-3]?>
            </td>
    ...
    <p class=Normal-Schedule style='margin-top:12.0pt;page-break-after:avoid'><b><span lang=EN-AU>&nbsp;</span></b></p>

    <p class=Normal-Schedule style='margin-top:12.0pt;page-break-after:avoid'><b><span lang=EN-AU>Documents setting out
                the design that is certified by this certificate</span></b></p>

    <p class=Normal-Schedule style='page-break-after:avoid'><b><span lang=EN-AU>&nbsp;</span></b></p>
    ...
    <table class=MsoNormalTable border=1 cellspacing=0 cellpadding=0 style='border-collapse:collapse;border:none'>
        <table border="1">
            ...
            for($y=1; $y<=$numofrows;$y++){?>
            <tr>
                <td><?php if(!empty($documentscertifiedarray[$y*5-5])) echo "&nbsp "; echo $documentscertifiedarray[$y*5-5]?>
                </td>
  ...
  padding:0cm 5.4pt 0cm 5.4pt'>
                <p class=Normal-Schedule style='margin-top:3.0pt;margin-right:0cm;margin-bottom:
  3.0pt;margin-left:0cm'><b><span lang=EN-AU>Act, Regulation, NCC, Australian
                            Standards</span></b></p>
            </td>
        </tr>
        <?php
    ...
    <p class=MsoNormal><span lang=EN-AU>I <?=$viccertificate->prepared?>
            <!-- insert prepared or not--> the design, or part of the design, set out in the documents
            listed above.</span></p>
    ...
    <p class=Normal-Schedule style='margin-top:12.0pt;page-break-after:avoid'><b><span lang=EN-AU
                style='font-size:14.0pt'>Engineer</span></b></p>

    <p class=Normal-Schedule><span lang=EN-AU>Name: Benjamin Marshall</span></p>

    <p class=Normal-Schedule><span lang=EN-AU>Address: Suite 283, 186 Queen Street,
            Melbourne 3000</span></p>

    <p class=Normal-Schedule><span lang=EN-AU>Email:
            BMarshall@marshallstructures.com.au</span></p>

    <p class=Normal-Schedule><span lang=EN-AU>Building practitioner registration
            category and class: Civil (structural)</span></p>
    ...
    <p class=Normal-Schedule><i><span lang=EN-AU>&nbsp;</span></i></p>
