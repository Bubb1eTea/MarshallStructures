        ...
        <div class="viccertificates form content">
            ...
            <fieldset>
                ...
                <?php
                    ...
                    echo $this->Form->control('documentscertifieds.0.documentno');
                    echo $this->Form->control('documentscertifieds.0.documentdate');
                    echo $this->Form->control('documentscertifieds.0.type');
                    echo $this->Form->control('documentscertifieds.0.numberofpage');
                    echo $this->Form->control('documentscertifieds.0.preparedby');
