...
class ViccertificatesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'dateofissue' => ['type' => 'timestamp', 'length' => null, 'precision' => null, 'null' => false, 'default' => 'current_timestamp()', 'comment' => ''],
        '_indexes' => [
            ...
            'FK_DOCUMENTSPRODUCEDS_VICCERTIFICATES' => ['type' => 'index', 'columns' => ['documentsproduced_id'], 'length' => []],
            'FK_DOCUMENTSCERTIFIEDS_VICCERTIFICATES' => ['type' => 'index', 'columns' => ['documentscertified_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'FK_PROJECTS_VICCERTIFICATES' => ['type' => 'foreign', 'columns' => ['project_id'], 'references' => ['projects', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'FK_DOCUMENTSPRODUCEDS_VICCERTIFICATES' => ['type' => 'foreign', 'columns' => ['documentsproduced_id'], 'references' => ['documentsproduceds', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'FK_DOCUMENTSCERTIFIEDS_VICCERTIFICATES' => ['type' => 'foreign', 'columns' => ['documentscertified_id'], 'references' => ['documentscertifieds', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'FK_COMPANYS_VICCERTIFICATES' => ['type' => 'foreign', 'columns' => ['company_id'], 'references' => ['companys', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
